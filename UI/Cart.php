...
<head>
    ...
    <script src="//cdn.shopify.com/s/files/1/0272/1493/8165/t/30/assets/jquery.currencies.min.js?v=7811281348689238064"
        type="text/javascript"></script>
    <script
        src="//cdn.shopify.com/s/files/1/0272/1493/8165/t/30/assets/jquery.owl.carousel.min.js?v=1202207770212250950"
        defer="defer"></script>
    ...
    <script src="//cdn.shopify.com/s/files/1/0272/1493/8165/t/30/assets/theme.js?v=15969572028892212420"
        defer="defer"></script>
    <script src="//cdn.shopify.com/s/files/1/0272/1493/8165/t/30/assets/global.js?v=13338212605681253444"
        defer="defer"></script>
    ...
    <script id="shopify-features"
        type="application/json">{"accessToken":"d8efa478165ba201a438240f394cbbe5","betas":["rich-media-storefront-analytics"],"domain":"nuranium-electronic.myshopify.com","predictiveSearch":true,"shopId":27214938165,"smart_payment_buttons_url":"https:\/\/cdn.shopify.com\/shopifycloud\/payment-sheet\/assets\/latest\/spb.en.js","dynamic_checkout_cart_url":"https:\/\/cdn.shopify.com\/shopifycloud\/payment-sheet\/assets\/latest\/dynamic-checkout-cart.en.js","locale":"en"}</script>
    ...
    <script
        id="__st">var __st = { "a": 27214938165, "offset": -14400, "reqid": "d5dec480-5471-497f-9046-964096e57820", "pageurl": "nuranium-electronic.myshopify.com\/pages\/about-us", "s": "pages-44824559669", "u": "cbf990589529", "cid": 5262876049461, "p": "page", "rtyp": "page", "rid": 44824559669 };</script>
    ...
    <script integrity="sha256-pVJhp6mHZ0dJmJmDtYierarGeV2NSFSPthRwqW7blSQ="
    ...
    <script>window.ShopifyAnalytics = window.ShopifyAnalytics || {};
        ...
        var meta = { "page": { "pageType": "page", "customerId": 5262876049461, "resourceType": "page", "resourceId": 44824559669 }, "evids": { "pv": "Page View", "vprd": "Viewed Product", "ps": "Performed Search" } };
    ...
    <script class="analytics">(function () {
            ...
            trekkie.ready(function () {
                ...
                window.ShopifyAnalytics.lib.page(null, { "pageType": "page", "customerId": 5262876049461, "resourceType": "page", "resourceId": 44824559669 });
...
<body class="template-page">
                        ...
                        <div id="mobile_search">
                            <form action="/search" method="get" class="search-header-inline search" role="search">
                                ...
                                <input class="search-header__input search__input" type="search" name="q"
                                    placeholder="Enter your keyword" aria-label="Search your product">
                                    ...
                                    <div class="group_items">
                                        <div class="form-account">
                                            <div class="form-account-title d-flex align-items-center"
                                                data-toggle="modal" data-target="#CustomerAccountForm">
                                            ...
                                            <div class="account-list dropdown-menu dropdown-menu-right"
                                                ...
                                                <div class="nov_sideward_content">
                                                    <div class="account-list-content">
                                                        ...
                                                        <div>
                                                            <a class="logout"
                                                                href="https://nuranium-electronic.myshopify.com/account/logout"
                                                                rel="nofollow" title="Log out">
                                                        ...
                                                        <div>
                                                            <a class="wishlist" href="/pages/page-wishlist"
                                                                rel="nofollow" title="My Wishlist">
                                ...
                                <div class="site_search d-flex align-items-center justify-content-end">
                                    <div class="site-header__search">
                                        <div id="search_widget" class="site_header__search">
                                            <form action="/search" method="get" class="search-header-inline search"
                                                role="search">
                                                <input type="hidden" name="type" value="product">
                                                <input class="search-header__input search__input" type="search" name="q"
                                                    placeholder="Enter your keyword" aria-label="Search your product">
                                                <button class="search-header__submit search__submit btn--link"
                                                    type="submit">
                                                    <span class="site-header__search-icon">
                                                        <i class="icon-search"></i>
                                                    </span>
            ...
            <section id="NovBreadcrumbs">
                <div class="container">
                  <ol class="breadcrumb list-inline" itemscope itemtype="http://schema.org/BreadcrumbList">
                    ...
                    <li class="active list-inline-item list-inline-item" itemprop="itemListElement" itemscope
                      itemtype="http://schema.org/ListItem">
        
                      <span itemprop="item"><span itemprop="name">Shopping Cart</span></span>
                            ...
                            <div class="col-xl-9 col-lg-9 col-md-12 col-sm-12 col-xs-12">
                                <div class="cart__layout_left">
                                    ...
                                    <div class="cart__body">
                                        <div class="row spacing-0 align-items-center line1 cart-flex cart_item pl-xs-15 pr-xs-15">
                                            <div class="col-md-1 cart__remove-wrapper text-center mb-xs-20">
                                                <a href="javascript:void(0)" onclick = "deleteItem(<?php echo $key ?>)" class="cart__remove">
                                                    <i class="fa fa-trash-o" aria-hidden="true"></i>
                                                </a>
                                                <a href="javascript:void(0)" class="btn btn--small-wide" onclick="updateItem(<?php echo $key?>)">Update</a>
                                            </div>
                                            <div class="col-md-5 cart__image-wrapper d-flex align-items-center mb-xs-20">
                                                <a href="#">
                                                    <img class="cart__image lazyload" style = "height: 92px;width: 92px"
                                                        src="<?php echo $_SESSION["cart"][$key]["image_blob"]?>"
                                                        alt="">
                                                </a>
                                            ...
                                            <div class="col-md-2 cart__price-wrapper mb-xs-20">
                                                ...
                                                <div><span class="money"><?php echo number_format($_SESSION["cart"][$key]["price"], 0, ',', '.')." "."VNĐ"?></span></div>
                                            </div>
                                            <div class="col-md-2 cart__update-wrapper mb-xs-20">
                                                <div class="cart__qty">
                                                    <input type="button" class="js-qty__adjust minus js-qty__adjust--minus" value="-" />
                                                    <input class="cart__qty-input" data-line="1" type="number" name="sl_<?php echo $key?>"
                                                        id="sl_<?php echo $key?>" value="<?php echo $_SESSION["cart"][$key]["soluong"]?>" step="1" min="1" max="12"
                                                        >
                                            ...
                                            <div class="col-md-2 total">
                                                ...
                                                <div class="product-subtotal">
                                                    <span class="money">
                                                        <?php 
                                                            echo ($total = number_format((($_SESSION["cart"][$key]["price"])*($_SESSION["cart"][$key]["soluong"])), 0, ',', '.'))." "."VNĐ";
                                                        ?>
                                                    </span>
                                                </div>
                                            </div>
    ...
    <script>
        ...
        function updateItem(id){
            sl = document.getElementById(`sl_'${id}'`).value;
        ...
        //     var num = document.getElementById(`sl_'${id}'`).value;
        //     alert(num);
        // }
