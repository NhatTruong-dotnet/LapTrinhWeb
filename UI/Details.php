          ...
          <div class="d-flex align-items-center">
            <div class="mobile_logo text-center">
              <a href="/" class="site-header__logo-image img-fluid">
                <img class="lazyload js" src="images/Logo.png" alt="" style="max-width: 150px;max-height: 70px;">
              </a>
            </div>
            ...
            <div class="row align-items-center">
              <div class="contentsticky_logo col-xl-3 col-lg-2 col-md-2">
                <div class="h2 site-header__logo" itemscope itemtype="http://schema.org/Organization">
                  <a href="Home.html" itemprop="url" class="site-header__logo-image" style="max-width: 150px;">
                    <img class="lazyload js img-fluid" src="images/Logo.png" alt="" style="height: 90px !important">
                  </a>
                </div>
              </div>
                ...
                <div class="site-header__icons-wrapper style_2">
                  ...
                  <div class="group_items">
                    <div class="form-account">
                      <div class="form-account-title d-flex align-items-center" data-toggle="modal"
                      ...
                      <div class="account-list dropdown-menu dropdown-menu-right" id="_desktop_account_list">
                        <div class="nov_sideward_content">
                          <div class="account-list-content">
                            <div>
                              <a class="myaccount" href="https://nuranium-electronic.myshopify.com/account"
                            ...
                            <div>
                              <a class="logout" href="https://nuranium-electronic.myshopify.com/account/logout"
                            ...
                            <div>
                              <a class="check-out" href="https://nuranium-electronic.myshopify.com/checkout"
                ...
                <nav id="AccessibleNav">
                  <ul class="site-nav list--inline " id="SiteNav">
                    ...
                    <li class="site-nav--has-dropdown hasMegaMenu center">
                      <a class="d-flex" href="About.html" title="About">
                        <div class="group_title">About</div>
                        <span class="d-none show_sub ml-auto"><i class="zmdi zmdi-plus-square"></i></span>
                      </a>
                    </li>
                    <li class="site-nav--has-dropdown hasMegaMenu center">
                      <a class="d-flex" href="Product.html" title="Products">
                        <div class="group_title">Products</div>
                        <span class="d-none show_sub ml-auto"><i class="zmdi zmdi-plus-square"></i></span>
                      </a>
                    </li>
                    <li class="site-nav--has-dropdown hasMegaMenu center">
                      <a class="d-flex" href="News.html" title="News">
                        <div class="group_title">News</div>
                        <span class="d-none show_sub ml-auto"><i class="zmdi zmdi-plus-square"></i></span>
                      </a>
                    </li>
                    <li class="site-nav--has-dropdown" aria-controls="SiteNavLabel-blog">
                      <a href="Contact.html" class="site-nav__link site-nav__link--main">Contact</a>
                    </li>
                  </ul>
                </nav>
              </div>
                    ...
                    <div id="search_widget" class="site_header__search">
                      ...
                      <script>
                        $(function () {
                          ...
                          var searchForms = $('form[action="/search"]').css('position', 'relative').each(
                            function () {
                              // Grabbing text input.
                                  ...
                                  currentAjaxRequest = $.getJSON(searchURL + '&view=json', function (data) {
                                    ...
                                    if (data.results_count == 0) {
                                      ...
                                      $.each(data.results, function (index, item) {
                                        ...
                                        link.append('<div class="thumbnail"><img src="' + item
                                          .thumbnail + '" /></div>');
                                        link.append('<div class="media-body"><div class="title">' +
                                          item.title + '</div><div class="price">' + item.price +
                                          '</div></div>');
                                      ...
                                      if (data.results_count > 10) {
                                        resultsList.append('<li><a class="see_all" href="' + searchURL +
                                          '">See all results (' + data.results_count + ')</a></li>');
                                      }
                                      resultsList.fadeIn(200);
                                    }
                                  });
