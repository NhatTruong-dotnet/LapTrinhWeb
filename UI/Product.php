						...
						<div class="container">
							<div class="row">
								...
								<?php
									...
									$totalRecords= mysqli_query($conn,"select *from sneoiuvk_laptrinhweb.product");
									$totalRecords=$totalRecords->num_rows;
									$totalPages=ceil($totalRecords/$item_per_page);
									$sql = "SELECT name,product.product_id,product_image.image_blob, price, currency, category_id FROM sneoiuvk_laptrinhweb.product join sneoiuvk_laptrinhweb.product_image on product.product_id=product_image.product_id  order by product.product_id desc limit $item_per_page offset $offset";
