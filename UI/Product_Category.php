							...
							<div class="row">
								...
								<div class="page-width product_deals col-md-9">
									...
									function danhmuc($a, $item_per_page, $offset)
									{
										...
										for ($j = 0; $j < sizeof($arr); $j += 1) {
											echo '<div class=" col-lg-4 col-md-6 col-sm-6 col-12">
										<div class="item">
	
											<div class="item-shadow" style="margin-bottom:50px">
												<div class="item-product" >
													<div class="thumbnail-container has-multiimage">
														<a href="Details.php?id=%27' . $arr[$j][4] . '%27" style="position:relative">
															<img class="img-fluid product__thumbnail lazyload"
																src="' . $arr[$j][1] . '"
																alt=""
																style="height:250px; width:250px">
															<div class="image-overlay-product" "></div>
														</a>
												...
												. $arr[$j][0] . '</a>
														...
														<div class="product__price" >
															...
															<div class="group-buttons" style="min-width: 60px;">
																<form class="formAddToCart add-cart-form-animation"  action="addcart.php?id=%27' . $arr[$j][4] . '%27" method="post" " >
