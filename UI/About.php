...
<head>
  ...
  <link rel="canonical" href="https://nuranium-electronic.myshopify.com/pages/about-us">
  ...
  <title>
    About Us&ndash; Hexa Food
                                            ...
                                            <li class="list-inline-item">
                                                <a href="#" title="Warehouse Electronic on Pinterest">
  ...
  <meta property="og:url" content="https://nuranium-electronic.myshopify.com/pages/about-us">
  ...
  <script id="__st">
    var __st = {
      "a": 27214938165,
      "offset": -14400,
      "reqid": "d5dec480-5471-497f-9046-964096e57820",
      "pageurl": "nuranium-electronic.myshopify.com\/pages\/about-us",
      "s": "pages-44824559669",
      "u": "cbf990589529",
      "cid": 5262876049461,
      "p": "page",
  ...
  <main class="main-content" id="MainContent">
    <section class="page-container" id="PageContainer">
      <div class="page-width">
        ...
        <div class="container">
          <div id="shopify-section-nov-page-about-us"
            class="shopify-section index-section page-about-us wow fadeIn animated">
            <div class="PageAboutUs">
              <center><img src="images/Logo.png" height="400" width="700"></center>
              <div class="block_text mt-35">
                <div class="title">Giới Thiệu</div>
                <div class="block_content">
                  <p>Trong đời sống vai trò của thực phẩm là rất quan trọng. Trên thực tế thực phẩm sẽ cung cấp cho con
                    người nguồn năng lượng, dưỡng chất để duy trì sự sống và phát triển cơ thể một cách toàn diện từ thể
                    lực cho tới trí tuệ. Tuy nhiên, thực phẩm bẩn, thực phẩm sử dụng hóa chất được bán tràn lan ở thị
                    trường gây ảnh hưởng nghiêm trọng tới sức khỏe của người tiêu dùng. Chúng ta cần hiểu được tầm quan
                    trọng và vai trò của thực phẩm sạch đối với cơ thể để có thể sáng suốt trong cách chọn thực phẩm cho
                    gia đình và cho bản thân mình .<br></p>
                  <p><br></p>
                  <h2>Vai trò của thực phẩm sạch đối với cơ thể:</h2>
                  <p>- Bảo đảm an toàn, không lo về vấn đề ngộ độc hay các hậu quả đáng tiếc khi sử dụng thực phẩm bẩn
                    như là nhiễm các mầm bệnh, đau bụng, thậm chí là ung thư hay tử vong.</p>
                  <p>- Thực phẩm sạch giúp cho sự phát triển vượt bậc về trí tuệ và thể lực khi nó cung cấp đầy đủ các
                    dưỡng chất quan trọng, cần thiết cho cơ thể.</p>
                  <p>- Tăng cường sức đề kháng, giảm thiểu các bệnh tật, sử dụng thực phẩm sạch bạn sẽ chế biến được các
                    món ăn ngon hơn, hấp dẫn hơn.</p>
                </div>
                <div class="block_content">
                  <p><br></p>
                  <h2>HEXA FOOD đảm bảo :</h2>
                  <p>- Hiểu được tâm lý người tiêu dùng, luôn cố gắng trau dồi và học hỏi để ra mắt các sản phẩm ngon
                    nhất, gần gũi nhất với đời sống hằng ngày.</p>
                  <p>- Thực hiện quy trình chế biến, các công đoạn cắt, ướp gia vị, sấy, đóng gói được đảm bảo vệ sinh
                    an toàn thực phẩm.</p>
                  <p>- Nguyên liệu được lựa chọn và kiểm tra kỹ càng, sử dụng nguyên liệu tươi ngon, không thuốc, không
                    có các chất độc hại để chế biến.</p>
                  <p>- Không sử dụng các chất bảo quản.</p>
                </div>
              </div>
              <div class="block_quote d-flex  mt-25 mb-25"><i class="fa fa-quote-left" aria-hidden="true"></i>
                <p> Cũng như mọi người , Hexa Company luôn mong muốn mình và gia đình mình được ăn uống sạch sẽ, healthy
                  nhất có thể . Từ đó Hexa Company quyết định nghiên cứu ra nhiều món ăn ngon, bổ và chắc chắn phải sạch
                  sẽ để đáp ứng nhu cầu các bé nhà mình. Song song đó được mọi người ủng hộ nên Hexa Food đã ra đời Hexa
                  Food với những kinh nghiệm và cái tâm của mình . Mẹ Cool tin rằng sẽ dành được sự tin tưởng và ủng hộ
                  của mọi người hơn nữa. &nbsp;</p>
              </div>
              <div class="block_text mb-55">
                <div class="title">THÀNH VIÊN</div>
              </div>
              <div class="block_our_team row">
                <div class="ourteam__item lazyload col-lg-3 col-md-4 col-sm-6 col-xs-12 mb-xs-30">
                  <div class="ourteam-author">
                    <img class="ourteam-avatar" src="images/TruongProfile.jpg" alt="Bùi Lê Hoàng Nhật Trường"
                      style="height: 300px;width: 300px;">
                  </div>
                  <div class="content-info">
                    <div class="ourteam_you">
                      <div class="ourteam-item__name">Bùi Lê Hoàng Nhật Trường</div>
                      <div class="ourteam-item__info">CEO</div>
                    </div>
                  </div>
                  <div class="content-contact">
                    ...
                    <div class="ourteam_email">
                      ...
                      <span> builehoangnhattruong@gmail.com</span>
                    </div>
                  </div>
                  <div class="block_social mt-30">
                    <ul class="list-inline mb-0">
                      <li class="list-inline-item">
                        <a href="#" title="Warehouse Electronic on Facebook">
                          <i class="zmdi zmdi-facebook"></i>
                        </a>
                      </li>
                      <li class="list-inline-item">
                        <a href="#" title="Warehouse Electronic on Twitter">
                      ...
                      <li class="list-inline-item">
                        <a href="#" title="Warehouse Electronic on Instagram">
                ...
                <div class="ourteam__item lazyload col-lg-3 col-md-4 col-sm-6 col-xs-12 mb-xs-30">
                  <div class="ourteam-author">
                    <img class="ourteam-avatar" src="images/TriProfile.jpg" alt="Nguyễn Trọng Trí"
                      style="height: 300px;width: 300px;">
                  </div>
                  <div class="content-info">
                    <div class="ourteam_you">
                      <div class="ourteam-item__name">Nguyễn Trọng Trí</div>
                      <div class="ourteam-item__info">CIO</div>
                    </div>
                  </div>
                  <div class="content-contact">
                    <div class="ourteam_hotline">
                    ...
                    <div class="ourteam_email">
                      <i class="icon-email"></i>
                      <span>dh51804141@student.stu.edu.vn</span>
                    </div>
                  </div>
                  <div class="block_social mt-30">
                    <ul class="list-inline mb-0">
                ...
                <div class="ourteam__item lazyload col-lg-3 col-md-4 col-sm-6 col-xs-12">
                  <div class="ourteam-author">
                    <img class="ourteam-avatar" src="images/SuongProfile.jpg" alt="Nguyễn Thanh Sướng"
                      style="height: 300px;width: 300px;">
                  </div>
                  <div class="content-info">
                    <div class="ourteam_you">
                      <div class="ourteam-item__name">Nguyễn Thanh Sướng</div>
                      <div class="ourteam-item__info">CFO</div>
                    </div>
                  </div>
                  <div class="content-contact">
                    <div class="ourteam_hotline">
                    ...
                    <div class="ourteam_email">
                      <i class="icon-email"></i>
                      <span>tendoshinra03090@gmail.com</span>
                    </div>
                  </div>
                  <div class="block_social mt-30">
                    <ul class="list-inline mb-0">
                ...
                <div class="ourteam__item lazyload col-lg-3 col-md-4 col-sm-6 col-xs-12 mt-md-30">
                  <div class="ourteam-author">
                    <img class="ourteam-avatar" src="images/ThuyProfile.jpg" alt="Trần Thị Ngọc Thùy"
                      style="height: 300px;width: 300px;">
                  </div>
                  <div class="content-info">
                    <div class="ourteam_you">
                      <div class="ourteam-item__name">Trần Thị Ngọc Thùy</div>
                      <div class="ourteam-item__info">Marketing Manager</div>
                    </div>
                  </div>
                  <div class="content-contact">
                    <div class="ourteam_hotline">
                    ...
                    <div class="ourteam_email">
                      <i class="icon-email"></i>
                      <span>dh51805688@student.stu.edu.vn</span>
                    </div>
                  </div>
                  <div class="block_social mt-30">
                    <ul class="list-inline mb-0">
          ...
          <div class="modal-body col-md-6 text-center d-flex justify-content-center align-items-end">
            <div class="subscribe_form">
              <div class="inner">
                ...
                <p>Sign up for newsletter to receive special offers and exclusive news about Our products</p>
                <div class="input-subscribe-wrap">
                  <input type="hidden" name="contact[tags]" value="newsletter">
                  <input type="email" name="contact[email]" class="inputNew form-control grey newsletter-input" value=""
                    placeholder="Enter your email">
                  <span class="input-group-btn mt-10 d-block">
                    <button id="Subscribe" type="submit" name="commit" class="btn btn-primary">Subscribe</button>
                  </span>
                </div>
                <div class="checkbox">
